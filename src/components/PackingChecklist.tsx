...
export const PackingChecklist: React.FC = () => {
  ...
  return (
    <section id="checklist" className="py-24 bg-slate-950 text-white relative">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Card Panel */}
        <div className="glass-panel-card p-6 sm:p-10 rounded-3xl border border-slate-800 space-y-6">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4 pb-6 border-b border-slate-800">
            <div className="flex items-center gap-2 bg-slate-900 p-1.5 rounded-2xl border border-slate-800">
              ...
              >
                ...
                <span>Winter & Snow Trip</span>
              </button>
            </div>

            <button
              onClick={handleCopy}
              className="flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-800 border border-slate-700 text-xs font-bold text-slate-200 rounded-xl transition"
            >
